...
[Sphinx_百度搜索](https://www.baidu.com/s?ie=UTF-8&wd=Sphinx)	

[为mathjax编写数学 — MathJax 3.2 文档](https://www.osgeo.cn/mathjax/basic/mathematics.html)	 [Sphinx — Sphinx 文档 - Sphinx 文档生成器](https://sphinx-doc.cn/en/master/)	 [Sphinx_百度百科](https://baike.baidu.com/item/Sphinx/14627)	  [使用ReadtheDocs托管技术文档 ](https://www.jianshu.com/p/8aae1c1453ae/)	[Read the Docs 在线文档搭建教程](https://www.cnblogs.com/phpper/p/16617573.html)	[Github + Sphinx+Read the docs 实战入门指南](https://zhuanlan.zhihu.com/p/618869114)	[Sphinx+gitee+Read the Docs搭建在线文档系统](https://cloud.tencent.com/developer/article/1849548)	 [文档编排 — 文档编排 1.0.0 documentation](https://docgenerate.readthedocs.io/en/latest/)	 

- 利用 [Sphinx](https://www.sphinx-doc.org/) 构建，使用了 [主题](https://github.com/readthedocs/sphinx_rtd_theme) 由 [Read the Docs](https://readthedocs.org/)开发
...
[GitHub Actions](https://blog.baoshuo.ren/post/auto-deploy-static-blog/)  
...
[Sphinx — Sphinx 文档 - Sphinx 文档生成器](https://sphinx-doc.cn/en/master/)			
...
杂：[Docsify](https://blog.csdn.net/weixin_48430685/article/details/134686299)     [docsify](https://developer.aliyun.com/article/821376)   
...
[docsify-katex](https://www.wenjinyu.me/docsify-make-a-notebook-application-of-your-own/)   [upupming/docsify-katex](https://github.com/upupming/docsify-katex)    

[让docsify-katex支持化学公式mhchem扩展](https://blog.csdn.net/witton/article/details/123529204)  

#### 更新日期

[docsify-updated](https://github.com/pfeak/docsify-updated/blob/master/zh-README.md)   
...
[docsify支持文本高亮](https://chat.baidu.com/search?word=docsify%E6%94%AF%E6%8C%81%E6%96%87%E6%9C%AC%E9%AB%98%E4%BA%AE&dyTabStr=MCwxMiwzLDEsMiwxMyw3LDYsNSw5&pd=csaitab&setype=csaitab&extParamsJson=%7B%22enter_type%22%3A%22search_a_tab%22%2C%22sa%22%3A%22vs_tab%22%2C%22apagelid%22%3A%229794391834393314424%22%2C%22ori_lid%22%3A%229794391834393314424%22%7D)   [高亮语法](https://blog.csdn.net/Hubz131/article/details/113062430)   

[百度AI搜索 - 办公学习一站解决](https://chat.baidu.com/search?word=html+%3D%3E+%7B&dyTabStr=MCwxMiwzLDEsMiwxMyw3LDYsNSw5&pd=csaitab&setype=csaitab&extParamsJson=%7B%22enter_type%22%3A%22search_a_tab%22%2C%22sa%22%3A%22vs_tab%22%2C%22apagelid%22%3A%2211002465529444767525%22%2C%22ori_lid%22%3A%2211002465529444767525%22%7D)  

通过 JavaScript 插件将 `==text== 替换为 <span class="mark">text</span>`‌

```javascript
plugins: [function(hook) {
  hook.beforeEach(html => {
    html = html.replace(/==(.+?)==/g, '<span class="highlight">$1</span>');
    //将更新时间加到文档的最顶部,需要插件docsify-updated
