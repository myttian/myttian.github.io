...
[正则表达式入门视频](https://www.bilibili.com/video/BV1Zx411f7bD?p=6&spm_id_from=pageDriver&vd_source=7346303e5e18677d7261c2c0c109ecfd)   

[RegexBuddy ](https://www.jianshu.com/p/65f9ccb01b34) [元字符-菜鸟教程 ](https://www.runoob.com/regexp/regexp-metachar.html)  [RegexBuddy使用](https://www.cnblogs.com/sindweller/p/14312227.html)  [正则表达式平衡组](https://www.codingdict.com/questions/26823)

杂：[元字符](https://t.cj.sina.com.cn/articles/view/1746173800/68147f680270124jr)  [正则](https://blog.csdn.net/qq_34402069/article/details/124796663)  [Regex Learn - 逐步从零基础到高阶](https://regexlearn.com/zh-cn)

[Regulex：JavaScript Regular Expression Visualizer_可视化理解正则](https://jex.im/regulex/#!flags=&re=%5E(a%7Cb)*%3F%24)   [正则语法 | 菜鸟教程](https://www.runoob.com/regexp/regexp-syntax.html)   [有正则视频](https://www.bilibili.com/video/BV1Kg411g7bC?p=41&spm_id_from=pageDriver&vd_source=7346303e5e18677d7261c2c0c109ecfd)  

[^$ 详解](https://www.cnblogs.com/echolun/p/12074720.html)  [grep、fgrep 和 egrep](https://math.ecnu.edu.cn/~jypan/Teaching/Linux/command/grep.htm?eqid=b92422ab00001416000000066475eae1) [grep和egrep](https://blog.csdn.net/qq_44370158/article/details/130840871)   [egrep和grep区别](https://m.elecfans.com/article/2175246.html) 

[精品：正则可视化](https://jex.im/regulex/#!flags=&re=(%5E.*t%20)(.*)(%2F.*%24))  [google课堂之正则表达式](https://blog.csdn.net/u013473520/article/details/49535903) [超常用的Python代码片段](https://blog.csdn.net/qq_37289115/article/details/88688065) 

元字符： [ASCII](https://baike.baidu.com/item/ASCII/309296?fr=ge_ala)   [转义序列字符(\0,\n,\r, \t,\v,\a,\f,\b,\\,\‘,\“,\?)](https://blog.csdn.net/2201_75670821/article/details/128247316)  [转义字符](https://baike.baidu.com/item/%E8%BD%AC%E4%B9%89%E5%AD%97%E7%AC%A6/86397?fr=ge_ala)    [字符编码](https://www.jianshu.com/p/415bff085a20)  [ASCII码对照表](https://blog.csdn.net/lj19990824/article/details/120162269)  

[ASCII中的控制字符](https://blog.csdn.net/gao_zhennan/article/details/118941799)  [ANSI控制码-\cJ等](https://blog.csdn.net/dolphin98629/article/details/109022111)   [常用ANSI控制码表_ansi码表](https://blog.csdn.net/zyj_zhouyongjun183/article/details/80211245?spm=1001.2101.3001.6650.3&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-3-80211245-blog-109022111.235%5Ev43%5Epc_blog_bottom_relevance_base9&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-3-80211245-blog-109022111.235%5Ev43%5Epc_blog_bottom_relevance_base9&utm_relevant_index=6) 

字符簇:

- 转义字符是==C语言中表示字符==的一种特殊形式。通常使用转义字符表示ASCII
...
- 分组和捕获
  ...
  - `(?: )`：用于分组但不捕获子表达式
  - 分组命名：`(?<groupname>exp)`
    - 反向引用： `\k<name>引用：  (?<name>\w+)\s+\k<name>`
...
```sh
FF (NP form feed, new page) 换页键 	# \f
CR (carriage return)回车键				# \r
LF (NL line feed, new line) 换行键		# \n
# \t制表符		\v垂直制表符

# html中/br  barter rabbet  换行 
```
...
# AnyCharExceptNewLine 除新行外的任何字符
...
[URL](https://www.cnblogs.com/fires/p/13606975.html)  [常用正则表达式](https://www.cnblogs.com/lucken2000/p/17382211.html) 
